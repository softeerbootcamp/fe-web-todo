...
let openTodoModal = document.querySelector('#open-modal-todo');
...
let openDoingModal = document.querySelector('#open-modal-doing');
...
let openDoneModal = document.querySelector('#open-modal-done');
